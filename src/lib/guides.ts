...
export const guides: Guide[] = [
  ...
  standard({
    slug: "nayc-2027-first-time-attendee-guide",
    eyebrow: "NAYC 2027",
    title: "NAYC 2027: First-Time Attendee Guide",
    description: "An independent APN planning guide for first-time North American Youth Congress 2027 attendees in Indianapolis, with official links for registration, hotels, and updates.",
    readingTime: "8 min read",
    intro: "North American Youth Congress 2027 is scheduled for July 28–30 in Indianapolis, Indiana. General sessions are planned for Lucas Oil Stadium, with split sessions at Lucas Oil Stadium and the Indianapolis Convention Center. This is an independent APN planning guide; use the official NAYC site for all registration, hotel, schedule, and event details.",
    foundationHeading: "Know the basics before your group begins planning",
    foundation: [
      "NAYC is a biennial UPCI Youth Ministries gathering focused on teenagers and young adults. The official site describes it as a gathering with worship services, preaching, and breakout or split sessions. A first-time attendee does not need to understand every part of the event before arriving, but should know the group’s plan and the official registration process.",
      "The official FAQ lists Indianapolis as the 2027 host city, Lucas Oil Stadium as the general-session venue, and the Indianapolis Convention Center and Lucas Oil Stadium for split sessions. Save the official NAYC site now because precise schedules and details can change as the event approaches.",
    ],
    practiceHeading: "Make a simple first-time plan",
    practice: [
      "Start with your church or district group leader. Confirm who is responsible for registration, hotel rooms, transportation, communication, and supervision. A clear group plan is more valuable than trying to figure everything out in a crowded hallway.",
      "Choose a few priorities: worship services, sessions that fit your season of life, time with your group, and a way to capture what God is speaking to you. Leave room for meals, travel, rest, and unexpected schedule changes.",
    ],
    actions: [
      "Save the official NAYC website and official dates before making travel plans.",
      "Ask your group leader how registration, hotels, transportation, and room assignments will work.",
      "Carry group contacts, hotel information, and a charged phone or printed backup.",
      "Take notes on one or two practical next steps to bring home after the event.",
    ],
    careHeading: "Come ready to participate with wisdom",
    care: [
      "NAYC can be exciting and crowded. Honor your church’s expectations, stay connected to the adults and leaders responsible for your group, and make wise choices about rest, meals, money, and time away from the group.",
      "Take care with photos, recordings, and social posts. Do not share another attendee’s private story or a vulnerable moment just because it feels meaningful in the moment.",
    ],
    faqs: [
      { question: "Where and when is NAYC 2027?", answer: "The official NAYC FAQ lists July 28–30, 2027, in Indianapolis, Indiana, with general sessions at Lucas Oil Stadium. Confirm current details through the official NAYC site." },
      { question: "Is this an official NAYC page?", answer: "No. This is an independent APN attendee guide. Use the official NAYC site for registration, hotels, schedules, policies, and event questions." },
    ],
    referencesHeading: "Official NAYC information",
    references: [{ label: "North American Youth Congress 2027", href: "https://northamericanyouthcongress.com/" }, { label: "Official NAYC FAQ", href: "https://northamericanyouthcongress.com/faqs/" }],
  }),
  standard({
    slug: "nayc-2027-registration-and-hotel-dates",
    eyebrow: "NAYC 2027",
    title: "NAYC 2027 Registration and Hotel Dates",
    description: "A planning guide for North American Youth Congress 2027 registration, hotel registration, Afterburner registration, group preparation, and official date reminders.",
    readingTime: "6 min read",
    intro: "Registration deadlines are easier to manage when a youth group prepares its information before the registration window opens. The official NAYC FAQ currently lists hotel registration opening January 19, 2027, event registration opening February 19, 2027, and Afterburner registration opening March 19, 2027—all at 6 p.m. Central Time. Confirm every date and requirement on the official site before acting.",
    foundationHeading: "Prepare before registration opens",
    foundation: [
      "A group leader should know the likely attendee count, adults or chaperones, room needs, transportation plan, payment process, and any local church deadlines before registration begins. Waiting to collect basic information after a registration window opens can create unnecessary pressure.",
      "Participants and parents should not assume a spot, room, or optional event is secured until their group leader confirms it through the official process. Keep official confirmations in an organized group record.",
    ],
    practiceHeading: "Use one group timeline",
    practice: [
      "Set internal deadlines before the official dates: an interest deadline, a deposit or payment conversation if your church uses one, a parent information meeting, and a final list review. Keep the official NAYC dates separate from your church’s internal deadlines so people understand which is which.",
      "Use the official site for current registration instructions. Do not share login details, payment information, or attendee data through informal group chats or unverified forms.",
    ],
    actions: [
      "Save the official hotel, event, and Afterburner registration dates in a shared group calendar.",
      "Collect only the information your group truly needs and protect it appropriately.",
      "Set internal church deadlines before official windows open.",
      "Keep official confirmation numbers and hotel details with authorized adult leaders.",
    ],
    careHeading: "Protect families from confusion and pressure",
    care: [
      "Communicate costs, expectations, deadlines, and cancellation realities clearly. A family should not be surprised by an expense or a policy because details were buried in a fast-moving group message.",
      "Avoid unofficial resale offers or messages claiming to represent NAYC. Use the official event website and approved group leaders for any registration, hotel, or optional-event action.",
    ],
    faqs: [
      { question: "When does NAYC 2027 hotel registration open?", answer: "The official FAQ currently lists January 19, 2027, at 6 p.m. Central Time. Confirm the date and process on the official NAYC site before booking." },
      { question: "When does NAYC 2027 event registration open?", answer: "The official FAQ currently lists February 19, 2027, at 6 p.m. Central Time. Check the official site for current requirements and updates." },
    ],
    referencesHeading: "Official NAYC information",
    references: [{ label: "Official NAYC FAQ and important dates", href: "https://northamericanyouthcongress.com/faqs/" }],
  }),
  standard({
    slug: "what-to-pack-for-nayc-2027",
    eyebrow: "NAYC 2027",
    title: "What to Pack for NAYC 2027",
    description: "A practical North American Youth Congress 2027 packing checklist for youth, parents, chaperones, and group leaders traveling to Indianapolis.",
    readingTime: "6 min read",
    intro: "A well-packed bag helps a young person focus on the event rather than searching for a charger, confirmation, medication, or a comfortable pair of shoes. Build your NAYC packing list around travel, long convention days, hotel routines, group expectations, and the official event guidance available close to departure.",
    foundationHeading: "Pack for a full group-trip rhythm",
    foundation: [
      "NAYC involves travel, stadium and convention-center sessions, meals, waiting periods, hotel nights, and time with a church group. Comfortable shoes, a day bag, a charger, and clearly labeled belongings are practical basics for a large gathering.",
      "Parents and participants should follow their local church’s trip expectations as well as any official event or venue rules. Check the official NAYC site close to the event for current guidance rather than assuming every item is permitted.",
    ],
    practiceHeading: "Use a three-part checklist",
    practice: [
      "Separate essentials you must carry, personal items that remain at the hotel, and group items or information held by leaders. That approach reduces the chance of losing something important in a crowded bag or assuming someone else packed it.",
      "Pack with the return trip in mind as well. Leave room for materials, purchases, or resources you may bring home, and keep receipts or important documents in a secure place.",
    ],
    actions: [
      "Carry: identification, official registration or group confirmation, hotel address, group contacts, charger, and needed medication.",
      "Wear: comfortable, appropriate shoes and clothing suited to your church and the event’s expectations.",
      "Bring: a note-taking method, refillable water container if venue rules permit, and a small amount of emergency money if your leaders recommend it.",
      "Label: bags, chargers, and anything likely to be separated from you during travel or sessions.",
    ],
    careHeading: "Pack with safety and respect in mind",
    care: [
      "Do not bring items that violate school, church, hotel, venue, airline, or event rules. A group leader can help answer questions before travel; guessing at a security checkpoint is not a good plan.",
      "Keep personal information and valuables secure. Young attendees should know who to contact if something is lost, if they feel unsafe, or if they are separated from the group.",
    ],
    faqs: [
      { question: "What is the most important item to pack for NAYC?", answer: "Bring your official registration or group confirmation, identification, group and hotel details, a charger, needed medication, and comfortable shoes." },
      { question: "Can I bring a bag into NAYC venues?", answer: "Venue and event rules can change. Check the official NAYC site and current venue guidance close to the event before packing." },
    ],
    referencesHeading: "Official NAYC information",
    references: [{ label: "North American Youth Congress 2027", href: "https://northamericanyouthcongress.com/" }, { label: "Official NAYC FAQ", href: "https://northamericanyouthcongress.com/faqs/" }],
  }),
  standard({
    slug: "nayc-2027-parent-and-chaperone-guide",
    eyebrow: "NAYC 2027",
    title: "NAYC 2027 Parent and Chaperone Guide",
    description: "A practical preparation guide for parents and chaperones supporting young people at North American Youth Congress 2027 in Indianapolis.",
    readingTime: "8 min read",
    intro: "Parents and chaperones make a youth event safer, calmer, and more meaningful when expectations are clear before the trip begins. This APN guide helps families prepare questions for their church group leader; it does not replace official NAYC policies or a local church’s responsibility for its students.",
    foundationHeading: "Agree on expectations before travel",
    foundation: [
      "A parent should understand the group’s travel plan, hotel arrangements, supervision model, communication expectations, emergency process, payment expectations, and return schedule. A chaperone should understand their assigned responsibilities and whom to contact when a decision needs adult leadership.",
      "Young people benefit when adults give clear expectations in advance. Explain group boundaries, curfew, meeting points, phone use, money, buddy systems, worship etiquette, and what to do if they are separated or uncomfortable.",
    ],
    practiceHeading: "Create a simple safety and communication plan",
    practice: [
      "Choose one group communication channel and one backup. Share the hotel address, leader contacts, travel itinerary, room-assignment process, and a clear meeting location. Parents should know when to expect updates without requiring a student to report every minute of the trip.",
      "Chaperones should not handle sensitive concerns alone. Follow the local church’s safeguarding procedures, involve the appropriate leadership, and protect a young person's privacy while acting promptly when help is needed.",
    ],
    actions: [
      "Attend or request a parent and participant information meeting before travel.",
      "Share emergency contacts, medical needs, and permissions only through the church’s approved secure process.",
      "Give every student an easy way to identify their leader, hotel, group contacts, and meetup point.",
      "Review group expectations for curfew, rooms, transportation, meals, money, and phone use.",
    ],
    careHeading: "Keep spiritual care and practical care together",
    care: [
      "NAYC can be spiritually significant, and it can also be physically tiring and emotionally intense. Help young people rest, eat, stay hydrated, and process what they are hearing without pressure to perform a particular response.",
      "Honor the trust parents place in leaders. Clear boundaries, appropriate supervision, and a prompt response to concerns are part of creating a healthy environment for young people.",
    ],
    faqs: [
      { question: "What should parents ask a NAYC group leader?", answer: "Ask about travel, hotels, supervision, room arrangements, communication, emergency procedures, costs, group expectations, and who is responsible for each part of the trip." },
      { question: "What should a chaperone bring?", answer: "Bring official group information, emergency contacts through the approved process, identification, a charged phone, necessary medication, and a clear understanding of your assigned responsibilities." },
    ],
    referencesHeading: "Official NAYC information",
    references: [{ label: "North American Youth Congress 2027", href: "https://northamericanyouthcongress.com/" }, { label: "Official NAYC FAQ", href: "https://northamericanyouthcongress.com/faqs/" }],
  }),
  standard({
    slug: "getting-around-indianapolis-for-nayc-2027",
    eyebrow: "NAYC 2027",
    title: "Getting Around Indianapolis for NAYC 2027",
    description: "A practical travel and transportation planning guide for North American Youth Congress 2027 attendees, church groups, parents, and chaperones in Indianapolis.",
    readingTime: "7 min read",
    intro: "Transportation becomes simpler when every attendee knows the hotel address, the meeting place, the adult responsible for the group, and the plan for getting between the hotel, Lucas Oil Stadium, the convention center, meals, and travel departures. Confirm current venue and local transportation details close to NAYC 2027.",
    foundationHeading: "Plan from your group’s actual starting point",
    foundation: [
      "A church group may arrive by plane, car, bus, or a combination of methods. Decide how you will get from the airport or arrival point to the hotel, how the group will reach event venues, and what happens if people are separated during a transition.",
      "The official NAYC FAQ identifies Lucas Oil Stadium for general sessions and the Indianapolis Convention Center plus Lucas Oil Stadium for split sessions. Check current routes, entrances, parking, and venue guidance rather than relying on a past-year map.",
    ],
    practiceHeading: "Build margin into the group schedule",
    practice: [
      "Large youth groups move more slowly than an individual traveler. Plan extra time for room checks, meals, walking, security, elevators, meeting up, and finding seats. A calm group usually leaves earlier than it thinks it needs to.",
      "Give students a specific meeting point and a precise time. ‘Meet by the door’ is not enough in a large stadium or convention center; use a named, recognizable location and have a backup plan.",
    ],
    actions: [
      "Save hotel, venue, and leader contact information offline as well as on a phone.",
      "Name an exact meetup point for before and after every major session.",
      "Build extra time into group travel, meals, security, and hotel transitions.",
      "Use official venue and local transportation sources close to departure for current details.",
    ],
    careHeading: "Keep young people connected to responsible adults",
    care: [
      "A transportation plan should reinforce supervision rather than make it harder. Avoid sending students alone to solve a logistics problem; give them a clear process for contacting their chaperone or designated adult.",
      "Normal travel wisdom matters: protect belongings, stay aware of surroundings, and use well-established transportation options approved by your group leaders.",
    ],
    faqs: [
      { question: "Where are NAYC 2027 sessions held?", answer: "The official FAQ lists Lucas Oil Stadium for general sessions and Lucas Oil Stadium plus the Indianapolis Convention Center for split sessions. Confirm current details on the official site." },
      { question: "How early should a group leave for NAYC sessions?", answer: "Leave more time than a normal local event for walking, lines, security, large-group coordination, and finding your meetup point." },
    ],
    referencesHeading: "Official NAYC information",
    references: [{ label: "Official NAYC FAQ", href: "https://northamericanyouthcongress.com/faqs/" }],
  }),
  standard({
    slug: "nayc-2027-group-leader-planning-guide",
    eyebrow: "NAYC 2027",
    title: "NAYC 2027 Group Leader Planning Guide",
    description: "A group-leader checklist for planning a safe, clear, spiritually meaningful North American Youth Congress 2027 trip for a local church or district group.",
    readingTime: "9 min read",
    intro: "A strong NAYC trip is built well before the bus, plane, or van leaves. Group leaders need a plan for registration, hotels, adult coverage, parent communication, travel, rooms, finances, emergency procedures, and follow-up after the event. Use official NAYC requirements and your church’s safeguarding policies as the foundation.",
    foundationHeading: "Build the leadership structure first",
    foundation: [
      "Name the adults responsible for registration, hotels, money, transportation, communication, spiritual care, and emergencies. One person does not need to do every task, but every task needs a clear owner and a way to escalate concerns.",
      "Create a planning timeline before official registration opens. Include internal interest and payment conversations, parent meetings, participant expectations, rooming process, travel arrangements, document collection through approved methods, and a final readiness review.",
    ],
    practiceHeading: "Give families one clear source of truth",
    practice: [
      "Use a single approved communication channel for confirmed details. When plans change, update that source first and then communicate the change clearly. Avoid making families piece together critical instructions from multiple group chats.",
      "Prepare a short participant guide with dates, contacts, expectations, packing reminders, travel plan, meeting points, payment information, and what to do if a student needs help. Review it with both parents and students.",
    ],
    actions: [
      "Assign responsible adults and a clear escalation process before collecting registrations.",
      "Set internal deadlines ahead of official NAYC registration and hotel dates.",
      "Use approved secure processes for private information and emergency needs.",
      "Hold a final parent and participant meeting before departure.",
    ],
    careHeading: "Plan for safeguarding, not just logistics",
    care: [
      "Follow your church or district’s policies for adult screening, supervision, transportation, rooms, medical information, behavior expectations, and responding to concerns. NAYC planning should never be an exception to healthy safeguarding practices.",
      "After the event, create a simple space for young people to reflect, ask questions, and carry a next step into local church life. The goal is not merely a successful trip; it is ongoing discipleship.",
    ],
    faqs: [
      { question: "What should a NAYC group leader prepare first?", answer: "Start with a leadership structure, official date reminders, an internal planning timeline, and clear communication for parents and participants." },
      { question: "How should leaders collect student information?", answer: "Use only your church or district’s approved secure process. Do not collect medical, contact, or other sensitive information in unsecured chats or public forms." },
    ],
    referencesHeading: "Official NAYC information",
    references: [{ label: "North American Youth Congress 2027", href: "https://northamericanyouthcongress.com/" }, { label: "Official NAYC FAQ and important dates", href: "https://northamericanyouthcongress.com/faqs/" }],
  }),
  standard({
    slug: "lucas-oil-stadium-and-convention-center-nayc-guide",
    eyebrow: "NAYC 2027",
    title: "Lucas Oil Stadium and Convention Center: NAYC 2027 Guide",
    description: "What NAYC 2027 attendees should know about moving between Lucas Oil Stadium and the Indianapolis Convention Center for general and split sessions.",
    readingTime: "6 min read",
    intro: "NAYC 2027 uses more than one event space. The official FAQ lists Lucas Oil Stadium for general sessions and Lucas Oil Stadium plus the Indianapolis Convention Center for split sessions. Knowing that before you arrive helps a group plan meeting points, walking time, accessibility needs, and a calmer session transition.",
    foundationHeading: "Understand the two-venue rhythm",
    foundation: [
      "General sessions are planned for Lucas Oil Stadium, while split sessions may take place at the stadium and the Indianapolis Convention Center. Check the official event schedule when it is released for the exact session locations, times, entrances, and any age or group guidance.",
      "Do not assume your whole group will attend every split session together. Agree in advance on how students choose sessions, who is responsible for each subset of the group, and where everyone reunites afterward.",
    ],
    practiceHeading: "Use exact meeting points and time buffers",
    practice: [
      "Large venues make vague directions risky. Identify one recognizable pre-session and post-session meeting point, tell students exactly when to be there, and give them the contact process if they are delayed.",
      "Plan for walking, crowds, restrooms, water, security, and group headcounts. A few minutes of margin turns a stressful transition into an ordinary part of the day.",
    ],
    actions: [
      "Review the official schedule for current session locations before each day.",
      "Choose clear group meetup points near every venue you plan to use.",
      "Assign adults to session groups before students separate.",
      "Build time for walking, headcounts, and unexpected changes.",
    ],
    careHeading: "Make accessibility and supervision visible in the plan",
    care: [
      "Ask participants and parents early about mobility, sensory, medical, or other needs that affect a large-venue day. Plan responsibly and use official venue guidance when a particular accommodation is needed.",
      "Keep the plan simple enough that a young attendee can repeat it: where to go, who to stay with, when to meet, and what to do if help is needed.",
    ],
    faqs: [
      { question: "Where are the NAYC 2027 general sessions?", answer: "The official FAQ lists Lucas Oil Stadium for general sessions. Confirm the current schedule and venue guidance before the event." },
      { question: "Where are NAYC 2027 split sessions?", answer: "The official FAQ lists the Indianapolis Convention Center and Lucas Oil Stadium for split sessions. Check the official schedule for exact locations and times." },
    ],
    referencesHeading: "Official NAYC information",
    references: [{ label: "Official NAYC FAQ", href: "https://northamericanyouthcongress.com/faqs/" }],
  }),
  standard({
    slug: "nayc-2027-afterburner-guide",
    eyebrow: "NAYC 2027",
    title: "NAYC 2027 Afterburner Guide",
    description: "A practical planning guide for groups considering NAYC 2027 Afterburner registration, with official-date reminders and questions to ask before committing.",
    readingTime: "5 min read",
    intro: "The official NAYC FAQ currently lists Afterburner registration opening March 19, 2027, at 6 p.m. Central Time. Before a group commits, verify the current official description, cost, eligibility, schedule, transportation implications, and whether the activity fits the group’s capacity and supervision plan.",
    foundationHeading: "Confirm the official details before making a group decision",
    foundation: [
      "Afterburner details can change, and the official NAYC site should be your source for its current description, registration requirements, and timing. Do not assume an activity from a prior event has the same format, cost, or expectations in 2027.",
      "A leader should consider whether the extra event fits the group’s travel, energy, budget, adult coverage, and parent communication plan—not just whether students are interested in it.",
    ],
    practiceHeading: "Ask the planning questions early",
    practice: [
      "Before registration opens, identify the participants who are interested, the adults available, any extra cost, the schedule impact, and what changes to flights, buses, hotels, or meal plans may be needed. Then communicate a clear decision and deadline to families.",
      "Keep official registration information separate from informal interest. A student saying they want to participate is not the same as a completed official registration.",
    ],
    actions: [
      "Verify current Afterburner information on the official NAYC site.",
      "Discuss budget, supervision, transportation, and schedule impact before registration opens.",
      "Set a clear internal decision deadline for families.",
      "Save official confirmations with authorized group leaders.",
    ],
    careHeading: "Do not overextend the group",
    care: [
      "An optional event should add value, not make travel unsafe or exhaust the students and adults responsible for them. It is okay for a group to choose a simpler plan if that better serves the people attending.",
      "Communicate the decision with grace. Not every family has the same budget or capacity, and a youth event should not create unnecessary comparison or pressure.",
    ],
    faqs: [
      { question: "When does NAYC 2027 Afterburner registration open?", answer: "The official FAQ currently lists March 19, 2027, at 6 p.m. Central Time. Confirm the current information on the official NAYC site." },
      { question: "What is the best way to plan for Afterburner?", answer: "Use the official event details, then evaluate cost, travel, supervision, energy, and schedule impact with your group leaders and parents before committing." },
    ],
    referencesHeading: "Official NAYC information",
    references: [{ label: "Official NAYC FAQ and important dates", href: "https://northamericanyouthcongress.com/faqs/" }],
  }),
  standard({
    slug: "what-happens-at-nayc",
    eyebrow: "NAYC 2027",
    title: "What Happens at NAYC?",
    description: "A first-time explanation of North American Youth Congress: worship services, preaching, split sessions, church groups, leadership, practical preparation, and follow-up.",
    readingTime: "7 min read",
    intro: "North American Youth Congress is a biennial UPCI Youth Ministries event for teenagers and young adults. The official NAYC site describes worship services, preaching, and practical breakout or split sessions. For many young people, it is both a powerful spiritual gathering and their first experience traveling with a large church group.",
    foundationHeading: "Expect worship, teaching, and group life",
    foundation: [
      "NAYC is more than a concert or a vacation. It includes worship services, preaching, focused sessions, travel, meals, hotel routines, conversations, and time with the local church group that came with you. Each part can be meaningful when it is approached with maturity and care.",
      "The exact 2027 schedule will be released and updated by NAYC. Use the official site for current details rather than treating a past-year schedule or a social-media clip as your plan for the event.",
    ],
    practiceHeading: "Come with a clear spiritual and practical posture",
    practice: [
      "Bring a way to take notes, ask honest questions, worship wholeheartedly, and receive what God may speak to you. At the same time, follow your group’s expectations and stay connected to the adults who are responsible for your care.",
      "After NAYC, talk with a pastor, youth leader, parent, or trusted mentor about what stood out. A meaningful conference moment grows when it becomes prayer, Scripture, obedience, and healthy involvement in a local church.",
    ],
    actions: [
      "Read the official NAYC FAQ before travel.",
      "Ask your group leader what the daily rhythm and expectations will be.",
      "Take notes on what you are learning and one next step to carry home.",
      "Stay with your group and use the help process if you are separated or concerned.",
    ],
    careHeading: "Keep the event in its right place",
    care: [
      "A large gathering can be inspiring, but it does not replace daily discipleship, local church community, or wise adult leadership. Do not measure your spiritual life by whether your experience looks like someone else’s.",
      "Honor the people around you. Listen well, be thoughtful online, and treat worship and personal conversations with the respect they deserve.",
    ],
    faqs: [
      { question: "Who is NAYC for?", answer: "The official NAYC site describes the event as focused on teenagers and young adults, with typical attendees ranging from junior-high ages upward. Check current official registration and group requirements." },
      { question: "Is NAYC only worship services?", answer: "No. The official site describes worship services, preaching, and practical breakout or split sessions. Check the official schedule for the current program." },
    ],
    referencesHeading: "Official NAYC information",
    references: [{ label: "North American Youth Congress 2027", href: "https://northamericanyouthcongress.com/" }, { label: "Official NAYC FAQ", href: "https://northamericanyouthcongress.com/faqs/" }],
  }),
  standard({
    slug: "nayc-2027-sermons-and-sessions",
    eyebrow: "NAYC 2027",
    title: "NAYC 2027 Sermons and Sessions: Where to Watch",
    description: "A pre-event guide to finding official NAYC 2027 sermons and sessions, plus APN’s plan to curate original links after the event.",
    readingTime: "5 min read",
    intro: "APN will not promise unofficial livestreams or repost complete NAYC messages without permission. When official NAYC 2027 sermons, session recordings, and resources are released, APN will help people find them by linking to the original sources and clearly naming the ministry or speaker involved.",
    foundationHeading: "Follow official channels for original content",
    foundation: [
      "The official NAYC website is the right place for current event and viewing information. Do not rely on disconnected clips or reposts that may remove a message from its context or omit the original source.",
      "Before and during the event, save the official site and your church group’s approved communication channel. After the event, look for original recordings and resource pages before sharing a message with others.",
    ],
    practiceHeading: "Use APN for curation after official material is available",
    practice: [
      "After official material becomes available, APN can organize original sermons, sessions, podcasts, and resources by useful themes such as prayer, identity in Christ, calling, leadership, youth ministry, and spiritual disciplines.",
      "Each APN card should link to the original source, name the speaker or ministry accurately, and offer a factual description that helps someone choose whether to watch the full message.",
    ],
    actions: [
      "Bookmark the official NAYC site for current announcements.",
      "Watch, listen to, or share complete official messages whenever possible.",
      "Use APN’s post-event collection to discover resources by topic after it is reviewed.",
      "Suggest a missing original public resource through APN’s content-submission process.",
    ],
    careHeading: "Keep context, attribution, and permissions intact",
    care: [
      "A short video clip can be encouraging, but it can also misrepresent a message. Preserve context by sharing the full official source and naming the original speaker or ministry.",
      "Respect copyright and platform rules. APN’s job is to help people discover excellent Apostolic content, not to claim ownership of work created by NAYC, speakers, churches, or ministries.",
    ],
    faqs: [
      { question: "Will APN livestream NAYC 2027?", answer: "No livestream is promised by APN. Use official NAYC channels for current viewing information. APN will curate links to original official sources when available." },
      { question: "Where will NAYC 2027 messages be available after the event?", answer: "Check official NAYC channels first. APN plans to publish a curated guide that links readers to original messages and resources after review." },
    ],
    referencesHeading: "Official NAYC information",
    references: [{ label: "North American Youth Congress 2027", href: "https://northamericanyouthcongress.com/" }, { label: "Official NAYC FAQ", href: "https://northamericanyouthcongress.com/faqs/" }],
  }),
  standard({
    slug: "apn-nayc-2027-message-guide",
    eyebrow: "NAYC 2027",
    title: "APN NAYC 2027 Message Guide",
    description: "How APN will curate North American Youth Congress 2027 sermons, sessions, podcasts, and resources after the event while linking to original sources.",
    readingTime: "5 min read",
    intro: "The APN NAYC 2027 Message Guide is a post-event resource collection in progress. Once official material is available, it will help young people, parents, youth leaders, and churches find original sermons, sessions, and practical resources without stripping away attribution or context.",
    foundationHeading: "Curation sends people to the source",
    foundation: [
      "APN will not treat another ministry’s message as its own. Every curated item should identify the original speaker or ministry, use a factual summary, and link directly to the official video, audio, article, or resource.",
      "That makes the guide useful while respecting the people and ministries that did the original work. It also gives a visitor the full context needed to receive a message wisely.",
    ],
    practiceHeading: "What the message guide will organize",
    practice: [
      "After NAYC, APN will sort reviewed official resources into paths that may help young people and leaders: prayer, worship, identity, calling, leadership, faithfulness, youth ministry, family conversations, and practical discipleship.",
      "Listings will be reviewed for working original links, accurate titles, clear attribution, and a description that explains what a resource is without overstating it.",
    ],
    actions: [
      "Browse original NAYC content by topic after the event.",
      "Save APN resources that serve a real spiritual or ministry need.",
      "Use each APN card to visit and support the original source.",
      "Suggest a missing official NAYC resource through APN’s content-submission process.",
    ],
    careHeading: "Choose quality over speed",
    care: [
      "APN will not label a message ‘best’ from a short clip or popularity count. Good curation takes context, accurate attribution, and a willingness to leave out material that cannot be responsibly sourced.",
      "A trustworthy resource library is maintained. If an original link changes or a recording is removed, APN should update or remove the listing rather than leave a misleading dead end.",
    ],
    faqs: [
      { question: "Is the APN NAYC 2027 Message Guide available now?", answer: "The guide structure is available before the event. Curated official sermons, sessions, and resources will be added after they are publicly available for review and linking." },
      { question: "Can I suggest a NAYC resource for APN?", answer: "Yes. Send APN the original public link and relevant details. APN can review it for accurate attribution, fit, and a working source link." },
    ],
    referencesHeading: "Official NAYC information",
    references: [{ label: "North American Youth Congress 2027", href: "https://northamericanyouthcongress.com/" }, { label: "Official NAYC FAQ", href: "https://northamericanyouthcongress.com/faqs/" }],
  }),
...
export const naycGuides = guides.filter((guide) => guide.eyebrow === "NAYC 2027");
